  ...
  return (
    <div className='flex items-center justify-between bg-white p-4 rounded-xl shadow border'>
      ...
      <div className='flex items-center gap-3'>
        <button className='p-2 cursor-pointer bg-gary-100 rounded-full hover:bg-gray-200'><FaMinus size={12}/></button>
            <span>{data.quantity}</span>
        <button className='p-2 cursor-pointer bg-gary-100 rounded-full hover:bg-gray-200'><FaPlus size={12}/></button>

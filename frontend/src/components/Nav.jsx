...
function Nav() {
  ...
  return (
    ...
    {showSearch && <div className='w-[90%] h-[50px] bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%]'>
      ...
      <h1 className='text-3xl font-bold mb-2 text-[#ff4d2d]'>Vingo</h1>
       ...
       {showSearch?<RxCross2 className=' text-[#ff4d2d] md:hidden' onClick={()=>setShowSearch(false)}/>:<IoIosSearch size={25} className=' text-[#ff4d2d] md:hidden' onClick={()=>setShowSearch(true)}/>}
